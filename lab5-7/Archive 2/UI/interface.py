...
class UI:
    ...
    def __init__(self):
        ...
        repon=GradeRepo()
        self._ctrn=GController(repon,rep,repo)
    ...
    def printmenu(self):
        ...
        print("6 - add laboratory")
        print("7 - remove laboratory")
        print("8 - update laboratory")
        print("9 - search laboratory")
        print("10 - print all laboratories")
        print("11 - give grade")
    ...
    def addlaboratory(self):
        nb = int(input("Give number of laboratory and problem: "))
        description = input("Give description ")
        deadline = input("Give deadline: ")
        p = self.__ctrl.add(nb, description, deadline)
        print ("problem was saved")
    ...
    def deletelaboratory(self):
        nb = int(input("Give the number of the problem: "))
        self._ctrl.deletelab(nb)
        print ("The problem was saved")
    ...
    def updatestudent(self):
        ...
        s = self._ctrs.uptud(id, name, group)
    ...
    def allstud(self):
        return self._ctrs.allstud()


    def alllab(self):
        return self._ctrl.alllab()
